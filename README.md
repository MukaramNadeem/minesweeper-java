...
> **Note:** To see the image above on GitHub, ensure you add the screenshot file to your repository root as `minesweeper-preview.png`.
...
- **Dynamic Board:** 10x10 Grid with 20 randomly placed mines.
...
1. Put the `GridPane` on the scene.
2. Wait for the player to click.
3. Handle the click appropriately (left or right click).
4. **Game Over:** If the player has lost, show all the mines and change the stage title/status label to indicate "Game Over".
5. **Victory:** If the player has won, change the stage title/status label to indicate a win.
6. **Restart:** Players can restart the game by clicking the reset button. This will create a new game, update the board, and reset the necessary states.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/<your-username>/minesweeper-javafx.git
